...
impl service::cmif::IClientObject for AppletNvDrvService {
...
impl service::cmif::IService for AppletNvDrvService {
...
impl service::cmif::IClientObject for SystemNvDrvService {
    fn new(session: sf::Session) -> Self {
        Self { session: session }
    }
}
...
impl service::cmif::IService for SystemNvDrvService {
    fn get_name() -> &'static str {
        nul!("nvdrv:s")
    }
