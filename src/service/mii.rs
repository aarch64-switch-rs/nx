...
impl sf::IObject for DatabaseService {
    ...
    fn get_command_table(&self) -> sf::CommandMetadataTable {
        vec! [
            ipc_interface_make_command_meta!(is_updated: 0),
            ipc_interface_make_command_meta!(is_full: 1),
            ipc_interface_make_command_meta!(get_count: 2),
            ipc_interface_make_command_meta!(get_1: 4),
            ipc_interface_make_command_meta!(build_random: 6)
        ]
    }
}
...
impl sf::IObject for StaticService {
    ...
    fn get_command_table(&self) -> sf::CommandMetadataTable {
        vec! [
            ipc_interface_make_command_meta!(get_database_service: 0)
        ]
    }
}
