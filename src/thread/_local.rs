...
/// [`Cell`] or [`RefCell`] is used (see the [`core::cell`] for more information
...
/// Declare a new thread local storage key of type [`crate::thread::LocalKey`].
///
/// # Syntax
///
...
/// ```
///
/// See [`LocalKey` documentation][`crate::thread::LocalKey`] for more
/// information.
///
/// [`crate::thread::LocalKey`]: crate::thread::LocalKey
#[macro_export]
